#ifndef _IK_STL_RBTREE_H_
#define _IK_STL_RBTREE_H_

#include "IK_Construct.h"
...
namespace IK_STL
{
	...
	public:
		...
		void swap(RBTree& t)
		{
			IK_STL::swap(header, t.header);
			IK_STL::swap(node_count, t.node_count);
			IK_STL::swap(key_compare, t.key_compare);
		}
